...
import net.benfro.fxgui.docks.containers.SingleDockContainer;
import net.benfro.fxgui.docks.containers.subcontainers.DockTabberContainer;
import net.benfro.fxgui.docks.containers.zones.DockZones;
import net.benfro.fxgui.docks.containers.zones.ZoneSelector;
