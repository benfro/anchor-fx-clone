 ...
 * MA 02110-1301  USA
 */
package net.benfro.fxgui.system;
...
public class AnchorageSystem {
   ...
   public static DockNode createDock(String title, Parent parent, Image icon) {
      DockUIPanel panel = new DockUIPanel(title, parent, false, icon);
      DockNode container = new DockNode(panel);
      return container;
   }
